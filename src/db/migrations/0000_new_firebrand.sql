...
CREATE INDEX `audit_log_org_idx` ON `audit_log` (`organization_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `space_profile_type_idx` ON `space_profile` (`type`);--> statement-breakpoint
